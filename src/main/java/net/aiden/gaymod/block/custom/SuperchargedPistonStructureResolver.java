...
public class SuperchargedPistonStructureResolver extends PistonStructureResolver {
    private static final int PUSH_LIMIT = 36;
    ...
    public SuperchargedPistonStructureResolver(Level p_60418_, BlockPos p_60419_, Direction p_60420_, boolean p_60421_) {
        super(p_60418_, p_60419_, p_60420_, p_60421_);
        this.level = p_60418_;
    ...
    private boolean addBlockLine(BlockPos p_60434_, Direction p_60435_) {
        ...
        if (level.isEmptyBlock(p_60434_)) {
            return true;
        } else if (!SuperchargedPistonBaseBlock.isPushable(blockstate, this.level, p_60434_, this.pushDirection, false, p_60435_)) {
            return true;
            ...
            int i = 1;
            if (i + this.toPush.size() > PUSH_LIMIT) {
                return false;
            } else {
                BlockState oldState;
                ...
                while(true) {
                    ...
                    if (!SuperchargedPistonBaseBlock.isPushable(blockstate, this.level, blockpos1, this.pushDirection, true, this.pushDirection) || blockpos1.equals(this.pistonPos)) {
                        return false;
                    }
                    ...
                    if (this.toPush.size() >= PUSH_LIMIT) {
                        return false;
                    }
